	...
	public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
		...
		try {
			if (isConsumerSide) {
				...
				logger.debug("生产者");
				String traceId = AttachmentUtil.getAttachment(invocation1, Constants.TRACE_ID);
				String parentId = AttachmentUtil.getAttachment(invocation1, Constants.PARENT_ID);
				String spanId = AttachmentUtil.getAttachment(invocation1, Constants.SPAN_ID);
